...
const translations = {
  en: {
    ...
    'newsletter.success.title': 'Welcome to our community!',
    'newsletter.success.description': 'You\'ll receive our weekly AI insights and tutorials directly in your inbox.',
  ...
  vi: {
    ...
    'newsletter.success.title': 'Chào mừng đến với cộng đồng của chúng tôi!',
    'newsletter.success.description': 'Bạn sẽ nhận được những hiểu biết và hướng dẫn AI hàng tuần trực tiếp trong hộp thư của mình.',
